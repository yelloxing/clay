...
(function (global, factory) {
    ...
    function _getCanvas2D(selector) {
        if (selector && selector.constructor === CanvasRenderingContext2D) return selector;else {
    ...
    clay.prototype.layer = function () {
        ...
        var layerManager = {
            ...
            "clean": function (ctx2D) {
                if (ctx2D) {
                    if (ctx2D.constructor !== CanvasRenderingContext2D) ctx2D = layerManager.painter(ctx2D);
